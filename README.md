...
<p align="center">
  <a href="https://github.com/Dr-juice001/Atlas-MD/fork">
...
<p align="center" >
    <a href="https://repl.it/github/Dr-juice001/Atlas-MD">
...
KEY | VALUE
-- | --
MODS | Phone numbers in this format (`263779694908`) without `+` or `SPACE`.
...
- [Download Updated code](https://github.com/Dr-juice001/Atlas-MD/archive/refs/heads/main.zip) from Main GitHub Repo or Download from your Forked Repo.
...
git clone https://github.com/Dr-juice001/Atlas-MD
...
``` 
- Note in `git clone <my bot's repo>` section your can use Your customised bot's github link too (For that make sure you [Forked](https://github.com/Dr-juice001/Atlas-MD/fork) this repo and modified `.env` file and `config.js`).
...
- Read [PublicKeys.md](https://github.com/Dr-juice001/Atlas-MD/blob/main/PublicKeys.md) to use our `provided public keys` if you are lazy to create your own. We have already provided everying you need to run the bot.
...
- Atlas comes with [MIT](https://github.com/Dr-juice001/Atlas-MD/blob/main/LICENSE.md) License which means you can use it as a `base for your own bot` and can `modify it as you want` and can `add your own features`.
...
- Check [Atlas Contributors](https://github.com/Dr-juice001/Atlas-MD/graphs/contributors) list.
